...
class Website(Base):
    ...
    login_hosts: Mapped[list[str]] = mapped_column(JSONB, default=list)
    allowed_redirect_origins: Mapped[list[str]] = mapped_column(JSONB, default=list)
...
class UserAPIToken(Base):
    ...
    __table_args__ = (
        UniqueConstraint("owner_id", "name", name="uq_user_api_tokens_owner_name"),
    )
    ...
    scope: Mapped[str] = mapped_column(String(50), default="service")
    is_active: Mapped[bool] = mapped_column(Boolean, default=True)
